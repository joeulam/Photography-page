        ...
        <motion.div id='cards'>
                    <div className='I01m'>
                        ...
                        <div className='descript'>
                            <h3 id='title'>"Dreamy Night"</h3>

                            <div className="info">
                                <h3>Iso: <span className='yellow'>3200</span> </h3>
                                <h3>Time: <span className='yellow'>6:27 pm</span></h3>
                                <h3>Aperture: <span className='yellow'>f/7.1</span></h3>
                                <h3>Exposure: <span className='yellow'>1/80</span></h3>
                            </div>
                        </div>
